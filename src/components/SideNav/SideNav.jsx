const SideNav = () => {
    return (
        <div className="flex flex-col fixed text-gray-700 p-4 hidden md:block">

        <div>

          <div className=" p-4">
            <h5 className="block font-sans text-sm text-gray-400">LEARN SKILLS</h5>
          </div>
        
          <nav className="flex flex-col gap-1 pt-0 font-sans text-base font-normal text-gray-700">
            ...
            <div className="p-4 mt-10">
              <h5 className="block font-sans text-sm text-gray-400">LEARN TOOLS</h5>
          </div>
